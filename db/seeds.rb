...
other_user = User.create(email: "blahblah@email.com", password: "123456")
user1 = User.create( email: "blahblahsfdf@email.com", password: "123456")
user2 = User.create( email: "blahblahfrg@email.com", password: "123456")
user3 = User.create(email: "blahblahsrgrrg@email.com", password: "123456")
user4 = User.create(email: "blahblahrgswefg@email.com", password: "123456")
